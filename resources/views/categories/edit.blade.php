<div class="row">
    <div class="col-md-6">
        <card class="card ">
            ...
            <div class="card-body">
                <form onsubmit="return false;" id="frm-categories" action="#" data-url="/categories/edit">
                    <input type="hidden" name="id" value="{{ $category->id }}">
                    <div class="form-group">
                        <label for="name">Nombre:</label>
                        <input value="{{ $category->name }}" type="text" class="form-control" id="name" name="name" autocomplete="off">
