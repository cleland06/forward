    ...
    <div class="col-md-6">
        <card class="card ">
            <h2 class="card-header d-flex justify-content-between align-items-center text-white bg-warning">
                Editar Usuario
                <button onclick="getView({url:'/users/index',btn:$(this),msj_finished:'Atrás'})" type="button" class="btn btn-sm btn-primary">Atrás</button>
            </h2>
            <div class="card-body">
                <form onsubmit="return false;" id="frm-users" action="#" data-url="/users/edit">
                    ...
                    <div class="form-group">
                        ...
                        <input value="" type="password" class="form-control" id="password" name="password" autocomplete="off">
                        <span  class="error invalid-feedback"><strong></strong></span>
                    </div>
                </form>
            ...
            let json_config = {
                ...
                .then(resp=>{
                    ...
                    if(resp.result.status == "Ok"){
                        getView({url:"/users/index",div_objet:'content'});
                    }
                });        
    })
</script>